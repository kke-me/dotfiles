...
- `/handoff`。Installs an untracked handoff/ directory into the current git repository. It holds STATE.md, BLOCKING.md, HUMAN.md, and log.jsonl, plus the kickoff, state, blocking, and human skills. Lists handoff/ in .git/info/exclude. Use when the user says /handoff.
